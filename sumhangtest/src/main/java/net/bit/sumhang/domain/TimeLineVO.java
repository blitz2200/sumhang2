...
public class TimeLineVO {
	...
	public String getTimeLineSphoto() {
		return timeLineSphoto;
	}
	public void setTimeLineSphoto(String timeLineSphoto) {
		this.timeLineSphoto = timeLineSphoto;
	}
	...
	public String toString() {
		return "TimeLineVO [timeLineNo=" + timeLineNo + ", tboardNo="
				+ tboardNo + ", userNo=" + userNo + ", timeLinePhoto="
				+ timeLinePhoto + ", timeLineSphoto=" + timeLineSphoto
				+ ", timeLineDesc=" + timeLineDesc + ", timeLineLike="
				+ timeLineLike + "]";
	}
